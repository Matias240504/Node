...
/**
 * Renderiza la vista de casos con estadísticas
 * @param {Object} req - Objeto de solicitud HTTP
 * @param {Object} res - Objeto de respuesta HTTP
 */
...
/**
 * Renderiza la vista de audiencias del abogado con estadísticas
 * @param {Object} req - Objeto de solicitud HTTP
 * @param {Object} res - Objeto de respuesta HTTP
 */
...
exports.obtenerSalasDisponibles = async (req, res) => {
  try {
    ...
    const salasDisponibles = todasLasSalas.filter(
...
/**
 * Renderiza la vista de casos del abogado con estadísticas
 * @param {Object} req - Objeto de solicitud HTTP
 * @param {Object} res - Objeto de respuesta HTTP
 */
exports.renderCasos = async (req, res) => {
